  ...
  return (
    <span ref={root} className="relative inline-flex items-stretch">
      <input
        ...
        className="border-input h-7 w-12 rounded-none border bg-transparent px-1 text-right text-xs [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
      />
      <button
        type="button"
