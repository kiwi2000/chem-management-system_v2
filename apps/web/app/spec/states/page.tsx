  ...
  return (
    <>
      ...
      <Section title="承認が要る場合と、要らない場合">
        ...
        <Sub title="だれがいつ判断したか（承認履歴）">
          <P>
            物質・製品の詳細の下に<T>「承認履歴」</T>の表が出ます。
            申請・承認・却下・取り下げ・公開の取りやめが、
            <T>日時・操作・実行した人・コメント</T>の順に新しいものから並びます。
            却下の理由を書いた場合は、コメントの欄に出ます。
          </P>
          <P>
            ほかの表と同じで、<T>絞り込み・並べ替え・ページ送り</T>が使えます。
            実行した人で絞るときは、名前でもメールアドレスでも当たります。 見られるのは
            <T>その種類を編集できる人と、承認できる人</T>だけです。
          </P>
        </Sub>
