...
export const ja = {
  ...
  groups: {
    ...
    editTitle: "グループの編集",
    description:
      "お知らせの分類と、組織の所属を登録します。ユーザーの編集画面でここのグループを割り当てます。",
    kind: "用途",
    kindNews: "お知らせの分類",
    kindOrg: "組織の所属",
    ...
    nameJa: "グループ名（日本語）",
    nameEn: "グループ名（English）",
    displayOrder: "表示順",
    displayOrderHint: "小さいほど先。お知らせの見出しの並び順にもなります",
    activeFlag: "このグループを使う",
    memberCount: "所属",
    members: (n: number) => `${n} 人`,
    empty: "グループがありません",
    deleteConfirm: (name: string) => `グループ「${name}」を削除しますか？`,
    inUse: "使用中のグループは削除できません。先に所属を外してください",
    /** 未所属・分類なしを表す選択肢 */
    none: "（なし）",
