...
export const ja = {
  common: {
    ...
    markDraft: "作成中に戻す",
    draftBadge: "作成中",
    markDoneSelected: "選択した行を完成にする",
    markDoneConfirm: (n: number) => `選択した ${n} 件を完成にしますか？`,
    markedSome: (updated: number, requested: number) =>
      `${requested} 件のうち ${updated} 件を変更しました（権限が無いものは変わっていません）`,
    search: "検索",
    create: "＋ 新規登録",
    open: "開く",
    close: "閉じる",
  ...
  permissions: {
    ...
    INACTIVE_VIEW: "無効・作成中のデータも見られる",
    INACTIVE_EDIT: "無効・作成中のデータも編集できる",
  ...
  permissionHints: {
    ...
    INACTIVE_VIEW:
      "作成中のデータと、無効にした製品を一覧・詳細で見られます（作成者は権限が無くても自分のぶんを見られます）",
  ...
  substances: {
    ...
    draftFlag: "作成中",
    draftFlagHint:
      "入力の途中で、まだ他の人に使わせたくないときにオンにします。組成の候補に出なくなります",
    draftDone: "完成",
    note: "備考",
    names: "名称",
    mainName: "主名称",
