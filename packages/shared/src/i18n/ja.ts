...
export const ja = {
  ...
  docTemplates: {
    ...
    file: {
      ...
      download: "落とす",
      remove: "外す",
      none: "まだ預けていません。Excel・Word の様式を預けてください",
      notFileKind:
        "この様式は画面で組むものです。作りかたを Excel か Word にしてから預けてください",
  ...
  docEditor: {
    ...
    orgBlock: "組織の項目",
    orgBlockHint:
      "組織を1つ選び、その項目を紙面に出します。差出人・宛先とは別に、様式へ書き込む組織です",
  ...
  documents: {
    ...
    fileBatch: "Excel・Word の様式は、まとめて作れません。1件ずつ作ってください",
    fileSaved:
      "ファイルの様式で作ったものです。控えは落としたファイルです。もう一度落とすには、作り直してください",
    template: "様式",
    targetKind: "種類",
    targetCode: "対象",
    hasComposition: "組成あり",
