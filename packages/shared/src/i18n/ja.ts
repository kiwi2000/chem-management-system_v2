...
export const ja = {
  ...
  sessions: {
    title: "セッション管理",
    description:
      "セッションは、ログインしてからログアウト（または時間切れ）までの1回分です。同じ人でも端末ごとに1つになります。ここには、いま生きているセッションが並びます。同じ人が2つの端末から入っていれば2行になります。行を選んで「ログアウトさせる」と、その端末のログインが切れ、相手の画面に理由が出ます。メンテナンスに入る前に、誰が使っているかを確かめるのに使ってください。",
    email: "メールアドレス",
    displayName: "表示名",
    loggedInAt: "ログイン日時",
    lastSeenAt: "最終操作",
