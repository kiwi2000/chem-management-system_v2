...
export const ja = {
  ...
  products: {
    ...
    addAlias: "＋ 別名を追加",
    flags: "取り扱い",
    usableAsMaterial: "原材料として使える",
    usableAsMaterialHint: "オンにすると、他の製品の組成に部品として入れられます",
    privateFlag: "非公開にする",
    privateFlagHint: "権限が無い人には、この製品の存在自体が見えなくなります",
    compositionPublicFlag: "組成を公開する",
    compositionPublicFlagHint: "オフにすると、製品は見えても組成は非開示になります",
    flagLocked: "この設定を変えるには、対応する閲覧権限が必要です",
    properties: "拡張属性",
    propertiesEmpty: "項目が定義されていません（システム管理者が設定します）",
    empty: "該当する製品がありません",
