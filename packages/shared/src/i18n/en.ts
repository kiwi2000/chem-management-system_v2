...
export const en: Messages = {
  ...
  products: {
    ...
    addAlias: "+ Add another name",
    flags: "Handling",
    usableAsMaterial: "Can be used as a raw material",
    usableAsMaterialHint:
      "When on, this product can be placed inside another product's composition",
    privateFlag: "Confidential",
    privateFlagHint: "People without the permission cannot see that this product exists",
    compositionPublicFlag: "Disclose the composition",
    compositionPublicFlagHint: "When off, the product is visible but its composition is withheld",
    flagLocked: "Changing this requires the matching view permission",
