...
export const en: Messages = {
  ...
  docEditor: {
    ...
    orgBlockHint:
      "Pick one organisation and print its items. Labels are yours to write (empty prints the value alone), and each line can be left, centred or right",
  ...
  documents: {
    ...
    step2: "Choose a recipient",
    step2Sender: "Choose sender and recipient",
    step2SenderOnly: "Choose a sender",
