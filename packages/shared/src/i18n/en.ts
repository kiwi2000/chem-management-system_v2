...
export const en: Messages = {
  common: {
    ...
    markDraft: "Back to in progress",
    draftBadge: "In progress",
  ...
  permissions: {
    ...
    INACTIVE_VIEW: "View inactive and in-progress data",
    INACTIVE_EDIT: "Edit inactive and in-progress data",
  ...
  permissionHints: {
    ...
    INACTIVE_VIEW:
      "See in-progress data and inactive products in lists and details (creators always see their own)",
  ...
  permissionGroups: {
    ...
    inactive: "Inactive / in-progress data",
  ...
  substances: {
    ...
    draftFlag: "In progress",
    draftFlagHint:
      "Turn on while you are still entering data. It will not appear as a composition candidate",
    draftDone: "Done",
    note: "Notes",
    names: "Names",
