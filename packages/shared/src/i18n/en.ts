...
export const en: Messages = {
  ...
  preferences: {
    ...
    themes: {
      ...
      sunset: "Sunset",
      rose: "Rose",
      navy: "Navy (dark header)",
      teal: "Teal (dark header)",
      wine: "Wine (dark header)",
      charcoal: "Charcoal (dark header)",
    ...
    themeDescriptions: {
      ...
      navy: "Navy top bar and table headers — a steady, businesslike look",
      teal: "Teal top bar and table headers",
      wine: "Deep red top bar and table headers",
      charcoal: "Dark grey top bar and table headers, with no colour cast",
