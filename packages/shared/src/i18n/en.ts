...
export const en: Messages = {
  ...
  nav: {
    ...
    groups: "Groups",
    users: "Users",
    propertyDefs: "Substance properties",
  ...
  groups: {
    ...
    description:
      "Announcement categories and organisational units. Assign them to people on the user edit screen.",
    kind: "Used for",
    kindNews: "Announcement category",
    kindOrg: "Organisational unit",
    kindNewsHint: "Announcements on the home screen are grouped under this heading",
    kindOrgHint: "Represents a department or team",
    nameJa: "Group name (Japanese)",
    nameEn: "Group name (English)",
    displayOrder: "Order",
    displayOrderHint: "Lower comes first. Also orders the announcement headings",
    activeFlag: "This group is in use",
    memberCount: "Members",
    members: (n: number) => `${n}`,
    empty: "No groups",
    deleteConfirm: (name: string) => `Delete the group "${name}"?`,
    inUse: "This group is still assigned to someone. Remove the assignments first",
    none: "(none)",
  ...
  users: {
    title: "Users",
    orgGroup: "Organisational unit",
    orgGroupHint: "One per person",
    newsGroup: "Announcement category",
