...
export const en: Messages = {
  ...
  loginLog: {
    ...
    lead: "Who signed in, when, and from where — including failures. A run of failures you cannot account for means someone is guessing passwords.",
    at: "When",
    result: "Result",
    success: "Signed in",
    failed: "Failed",
